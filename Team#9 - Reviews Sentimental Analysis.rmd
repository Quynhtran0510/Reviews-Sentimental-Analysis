...
```
Observation: Looking at the table, we can see that a total of  1261 + 1062 + 3873 = 6195 of the 9358 text were correctly classified (66.2%).
...
```
Observation: Looking at the table, we can see that a total of 1345 + 1129 + 3592 = 6035 of the 9358 text were correctly classified (64.82%), decreased 1%.
